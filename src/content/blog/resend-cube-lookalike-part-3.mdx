...
Using code inspired by this <a class="external" href="https://jsfiddle.net/MadLittleMods/n6u6asza/" target="_blank">jsfiddle</a>, we can rotate the cube on drag instead of rotating the camera, which stays fixed - allowing us to place the lights outside of the camera view, but still casting light on the cube.
